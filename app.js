(() => {
  ...
  // src/main.js
  var STATE_KEYS = ["section", "text", "target", "nameA", "motherA", "nameB", "motherB", "role", "father", "mother", "desiredBabyName", "maleSearch", "femaleSearch", "awfaqText", "rank"];
  ...
  var state = { section: "calculator", text: "", target: "", nameA: "", motherA: "", nameB: "", motherB: "", role: "\u0637\u0627\u0644\u0628", father: "", mother: "", desiredBabyName: "", maleSearch: "", femaleSearch: "", awfaqText: "", rank: 4, history: [], suggestionLimit: 12, ...stored, ...readSharedState() };
  ...
  function names() {
    ...
    return `${suggestions()}<section class="card"><h2>\u0645\u0642\u0627\u0631\u0646\u0629 \u0627\u0633\u0645\u064A\u0646</h2><p class="muted">\u0627\u0644\u062D\u0633\u0627\u0628 \u062D\u0631\u0641\u064A \u0648\u0645\u0646\u0647\u062C\u064A\u060C \u0648\u0644\u064A\u0633 \u062A\u0648\u0642\u0639\u064B\u0627 \u0623\u0648 \u062D\u0643\u0645\u064B\u0627 \u0639\u0644\u0649 \u0627\u0644\u0623\u0634\u062E\u0627\u0635.</p><div class="split"><div><h3>\u0627\u0644\u0634\u062E\u0635 \u0627\u0644\u0623\u0648\u0644</h3><input data-field="nameA" value="${esc(state.nameA)}" placeholder="\u0627\u0644\u0627\u0633\u0645"><input data-field="motherA" value="${esc(state.motherA)}" placeholder="\u0627\u0633\u0645 \u0627\u0644\u0623\u0645 (\u0627\u062E\u062A\u064A\u0627\u0631\u064A)" style="margin-top:8px"></div><div><h3>\u0627\u0644\u0634\u062E\u0635 \u0627\u0644\u062B\u0627\u0646\u064A</h3><input data-field="nameB" value="${esc(state.nameB)}" placeholder="\u0627\u0644\u0627\u0633\u0645"><input data-field="motherB" value="${esc(state.motherB)}" placeholder="\u0627\u0633\u0645 \u0627\u0644\u0623\u0645 (\u0627\u062E\u062A\u064A\u0627\u0631\u064A)" style="margin-top:8px"></div></div><div class="actions"><label class="chip">\u062F\u0648\u0631 \u0627\u0644\u0623\u0648\u0644 <select data-field="role" style="width:auto;padding:0;border:0;background:transparent"><option ${state.role === "\u0637\u0627\u0644\u0628" ? "selected" : ""}>\u0637\u0627\u0644\u0628</option><option ${state.role === "\u0645\u0637\u0644\u0648\u0628" ? "selected" : ""}>\u0645\u0637\u0644\u0648\u0628</option></select></label><button class="btn" data-name-example>\u062F\u0627\u0648\u062F \xD7 \u062C\u0627\u0644\u0648\u062A</button><button class="btn" data-export-names>\u062A\u0635\u062F\u064A\u0631 \u0628\u0637\u0627\u0642\u0629</button><button class="btn" data-copy-link>\u0646\u0633\u062E \u0627\u0644\u0631\u0627\u0628\u0637</button><button class="btn" data-clear="names">\u0645\u0633\u062D</button></div></section><div class="split"><section class="card"><h3>\u0628\u0637\u0627\u0642\u0629 \u0627\u0644\u0634\u062E\u0635 \u0627\u0644\u0623\u0648\u0644</h3>${profileCard(a)}${state.motherA ? '<p class="notice">\u0627\u0644\u062D\u0633\u0627\u0628 \u0645\u062F\u0645\u062C \u0645\u0639 \u0627\u0633\u0645 \u0627\u0644\u0623\u0645.</p>' : ""}</section><section class="card"><h3>\u0628\u0637\u0627\u0642\u0629 \u0627\u0644\u0634\u062E\u0635 \u0627\u0644\u062B\u0627\u0646\u064A</h3>${profileCard(b)}${state.motherB ? '<p class="notice">\u0627\u0644\u062D\u0633\u0627\u0628 \u0645\u062F\u0645\u062C \u0645\u0639 \u0627\u0633\u0645 \u0627\u0644\u0623\u0645.</p>' : ""}</section></div>${comparison ? `<section class="card"><h3>\u0627\u0644\u063A\u0627\u0644\u0628 \u0648\u0627\u0644\u0645\u063A\u0644\u0648\u0628</h3><div class="result"><b>${comparison.winner === state.role ? esc(state.nameA) : esc(state.nameB)} \u063A\u0627\u0644\u0628</b> \u2014 ${comparison.winner === state.role ? esc(state.nameB) : esc(state.nameA)} \u0645\u063A\u0644\u0648\u0628<p class="muted">${comparison.reason}</p><span class="tag">GHALIB-SIRR-1.0</span></div></section><section class="card"><h3>\u0627\u0644\u062A\u0648\u0627\u0641\u0642</h3><div class="reference"><div class="result"><b>${elements.kind}</b><p class="muted">${elements.text}</p><span class="tag">TABIA-MASHRIQI-1.0 \xB7 COMPAT-ELEMENTS-1.0</span></div><div class="result"><b>\u0627\u0644\u0645\u0631\u0627\u0633\u0644\u0627\u062A \u0627\u0644\u0641\u0644\u0643\u064A\u0629 \u0627\u0644\u062D\u0631\u0641\u064A\u0629</b><p class="muted">${celestial.planet}<br>${celestial.zodiac}</p><span class="tag">FALAK-STATIC-1.0 \xB7 BURJ-MOD12-1.0</span></div></div></section>` : ""}`;
  }
